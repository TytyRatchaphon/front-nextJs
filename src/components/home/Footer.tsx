      ...
      <div className="max-w-[1440px] mx-auto px-4 pt-[180px] sm:pt-[220px] lg:pt-[280px] pb-8 flex flex-col h-full justify-between">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-2 text-gray-600 text-sm">
              ...
              <li><Link href="#" className="hover:text-red-500">วิธีเติมเหรียญ / ระบบเหรียญ</Link></li>
              <li><Link href="#" className="hover:text-red-500">คู่มือนักเขียน</Link></li>
              <li><Link href="#" className="hover:text-red-500">คำถามที่พบบ่อย (FAQ)</Link></li>
            </ul>
          </div>
          <div className="flex flex-col">
            <h3 className="font-bold text-lg mb-4 text-gray-800">ข้อกำหนดและนโยบาย</h3>
            <ul className="space-y-2 text-gray-600 text-sm">
              <li><Link href="#" className="hover:text-red-500">นโยบายความเป็นส่วนตัว</Link></li>
              <li><Link href="#" className="hover:text-red-500">ข้อกำหนดการใช้งาน</Link></li>
              <li><Link href="#" className="hover:text-red-500">เงื่อนไขการลงทะเบียนนักเขียน</Link></li>
            </ul>
          </div>
          <div className="flex flex-col">
            <h3 className="font-bold text-lg mb-4 text-gray-800">เกี่ยวกับเรา</h3>
            <ul className="space-y-2 text-gray-600 text-sm">
              <li><Link href="#" className="hover:text-red-500">เกี่ยวกับ EVEEBOOK</Link></li>
              <li><Link href="#" className="hover:text-red-500">ข่าวสารและกิจกรรม</Link></li>
            </ul>
          </div>
          <div className="flex flex-col">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pt-6 border-t border-gray-100">
          ...
          <div className="flex flex-col items-center md:items-end gap-2 text-gray-400">
             ...
             <p className="text-xs mt-2 ">Copyright © PAOPAOBOOK CO., LTD.</p>
          </div>
        </div>
      </div>
    </footer>
