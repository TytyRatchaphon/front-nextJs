             ...
             <Popover
                content={
                  <div className="max-w-xs md:max-w-sm text-sm p-2 space-y-1">
                    ...
                    <p>• แจกสแตมป์ถึงวันที่ 31 ธันวาคม 2569</p>
                    <p>• สแตมป์ใช้แลกรางวัลได้ถึงวันที่ 31 ธันวาคม 2569</p>
                    <p>• สแตมป์จะถูกลบออกจากระบบในวันที่ 31 ธันวาคม 2569 เวลา 23.59 น.</p>
