...
const AddToCartSvg = ({ className, width = 24, height = 24, color = "#FFFFFF" }: { className?: string, width?: number, height?: number, color?: string }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M8.81043 2L5.19043 5.63" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M15.1904 2L18.8104 5.63" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
