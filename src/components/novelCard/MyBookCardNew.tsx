      ...
      <div className="relative w-full h-[237px] mb-2 overflow-hidden rounded-lg shadow-sm">
        ...
        {hasPendingReportIssue && (
          <button
            ...
            className="absolute left-2 top-2 z-10 inline-flex items-center gap-1 rounded-full border border-red-400 bg-red-50/95 px-2.5 py-1 text-[11px] font-semibold text-red-800 shadow-sm backdrop-blur transition hover:bg-red-100"
          >
