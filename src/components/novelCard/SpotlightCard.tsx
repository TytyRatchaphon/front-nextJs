        ...
        <div className="mt-2">
          ...
          <div className="flex items-center gap-4 text-sm mt-1 text-gray-500">
            ...
            <div className="hidden lg:flex items-center gap-1">
             ...
             {/* Like/Heart or Rating? - Mock used heart-like shape? No, mock used "Love" icon path... wait, let's stick to user mock SVG */}
             <div className="flex items-center gap-1">
               {/* This is the SVG from user mock which looks like a heart/shield? Actually the path `d="M15.58 12C15.58 13.98..."` is a Heart icon probably */}
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-500">
