...
function CardBook({ book }: CardBookProps) {
  ...
  return (
  <div className="w-full max-w-[180px] h-[355px] flex-shrink-0 relative z-0">
    <Link 
  ...
  <div className="px-3 pt-3 pb-2 flex flex-col gap-1 flex-1">
          <h3 className="text-black text-base font-primary font-medium group-hover/card:text-red-600 transition-colors duration-300 line-clamp-2 min-h-[2.5rem]">
            {book.name}
          </h3>
