  ...
  const userMenuContent = (
    <>
      <div className="p-2 rounded-lg" style={{ width: '320px', backgroundColor: '#FFE8F0' }} >
        ...
        {/* Rank Badge */}
        {rankData && (
          <Link href="/mprofile" onClick={() => setIsUserMenuOpen(false)} className="mt-2 flex items-center justify-between bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl px-3 py-2.5 border border-gray-200 hover:border-gray-300 transition-all duration-200 group">
      ...
      <Link href="/mprofile" onClick={() => setIsUserMenuOpen(false)} className="group flex items-center gap-3 px-4 py-3 hover:bg-gray-100 transition-all duration-200 rounded-lg">
