...
export default function PrivacyPolicyContent() {
    ...
    const rawHtml = settings?.policy || settings?.privacy_policy || '';
    const safePrivacyHtml = sanitizeUserGeneratedHtml(rawHtml);
    const { htmlWithIds, toc } = useHtmlToc(safePrivacyHtml);
