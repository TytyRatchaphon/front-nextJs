...
export default function WriterNCPolicyContent() {
    const { settings, isLoading } = useWebsiteSettings();
    const safeWriterNcHtml = sanitizeUserGeneratedHtml(settings?.nc || '');
                ...
                <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 lg:p-14 rounded-3xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] border border-gray-100">
                    {isLoading ? (
                        ...
                        <div
                            ...
                            dangerouslySetInnerHTML={{ __html: safeWriterNcHtml }}
                        />
                    ) : (
