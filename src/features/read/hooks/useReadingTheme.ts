...
export function useReadingTheme(
    ...
    useEffect(() => {
        ...
        const userPopoverCss = bgColor === 'dark'
         ...
         .reader-user-drawer .ant-drawer-content,
         .reader-user-drawer .ant-drawer-header,
         .reader-user-drawer .ant-drawer-body {
            background-color: ${colors.bg} !important;
         ...
         .reader-user-drawer .ant-drawer-close {
            color: ${colors.text} !important;
         }
        ...
        #Navbar .reader-novel-dropdown-box { background-color: ${colors.bg} !important; border-color: ${colors.border} !important; }
        #Navbar .reader-novel-dropdown-box * { border-color: ${colors.border} !important; }
        #Navbar .reader-novel-dropdown-box .text-gray-600, #Navbar .reader-novel-dropdown-box .text-gray-500, #Navbar .reader-novel-dropdown-box button, #Navbar .reader-novel-dropdown-box a, #Navbar .reader-novel-dropdown-box .text-gray-800, #Navbar .reader-novel-dropdown-box h3 { color: ${colors.text} !important; }
        #Navbar .reader-novel-dropdown-box .text-red-600, #Navbar .reader-novel-dropdown-box a:hover { color: #dc2626 !important; }
        #Navbar .reader-novel-dropdown-box button:hover { background-color: ${colors.border} !important; color: #dc2626 !important; }
         #Navbar .reader-novel-dropdown-box button.shadow-sm { background-color: ${colors.border} !important; color: #dc2626 !important; }
         #Navbar .reader-novel-dropdown-box svg { color: inherit !important; }
