             ...
             <div key={book.book_id} className="bg-white rounded-xl p-4 flex gap-4 md:gap-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="relative shrink-0 w-[100px] md:w-[140px] aspect-[2/3]">
                   ...
                   <div className="absolute -top-2 -left-2 z-10">
                      <div className="relative w-8 h-8 md:w-10 md:h-10">
                         ...
                         <div className={`w-full h-full flex items-center justify-center rounded-full text-xs md:text-sm font-bold shadow-sm bg-white border ${
                            book.rank === 1 ? 'border-yellow-400 text-yellow-500' :
                ...
                <div className="flex-1 flex flex-col justify-start py-1 min-w-0">
                   ...
                   <div className="flex flex-wrap gap-2 mb-auto w-full overflow-hidden">
                      <TagSwiper tags={book.tag ? book.tag.split(',').filter(t => t.trim() !== '') : []} classImport="px-2 py-0.5 rounded-full border border-red-300 text-red-500 text-[10px] md:text-xs bg-red-50 whitespace-nowrap" />
                   </div>
