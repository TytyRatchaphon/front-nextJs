...
import BookInfoCardPromotionConfirmModal from "./BookInfoCardPromotionConfirmModal";
import type {
...
type BookInfoCardPurchaseModalsProps = {
  ...
  promotionConfirmOpen: boolean;
  onClosePromotionConfirm: () => void;
  onConfirmPromotionPurchase: () => void | Promise<void>;
};
...
export default function BookInfoCardPurchaseModals({
  ...
  onClosePromotionConfirm,
  onConfirmPromotionPurchase,
  ...
  return (
    <>
      ...
      <BookInfoCardPromotionConfirmModal
        book={book}
        open={promotionConfirmOpen}
        settings={settings}
        promotion={book.promotion ?? null}
        payWith={payWith}
        buyLoading={buyLoading}
        onClose={onClosePromotionConfirm}
        onConfirm={onConfirmPromotionPurchase}
        onPayWithChange={onPayWithChange}
      />
    </>
  );
