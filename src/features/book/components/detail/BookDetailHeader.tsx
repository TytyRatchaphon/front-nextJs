...
import { useAddBookToShelfMutation, useRemoveBookFromShelfMutation, useSaveBookShareMutation } from "@/features/book/hooks/useBookWriteMutations";
...
import BookCollectionPickerModal from "./BookCollectionPickerModal";
...
const BookDetailHeaderContent = ({ book, episodesData, videoData }: BookDetailHeaderProps) => {
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="relative rounded-lg shadow-sm p-2 sm:p-6">
        {/* Backdrop background separated to prevent containing block trap for fixed modals */}
        <div className="absolute inset-0 bg-white/50 backdrop-blur-sm rounded-lg pointer-events-none"></div>
