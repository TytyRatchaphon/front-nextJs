...
`}} />
      ...
      >
        ...
        <div 
          className={
            isModalOpen 
              ? "fixed inset-0 z-[99999] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4" 
        ...
        >
          ...
          {isModalOpen && (
            <button 
              ...
              className="absolute top-4 right-4 text-white/70 hover:text-white p-2 z-[100000] transition-colors"
              aria-label="ปิด"
            >
              <X className="w-8 h-8" />
            </button>
