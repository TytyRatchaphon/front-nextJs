...
function WriterProfileContent() {
    ...
    const writerId = searchParams.get("id") || "16113"; 
    ...
    const fetchBooks = async () => {
        ...
        try {
            ...
            console.error("Failed to fetch writer books", error);
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleFollow = async () => {
        ...
        if (!token) {
            messageApi.warning("กรุณาเข้าสู่ระบบก่อนติดตาม");
            return;
        }
    ...
    return (
        <div className="min-h-screen bg-white font-primary pb-10">
            ...
            <div className="container mx-auto px-4 relative z-10 -mt-16 mb-8 md:mb-12">
                <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-4 md:p-6 flex flex-col md:flex-row items-center md:items-end gap-4 md:gap-6 border border-gray-100/50">
                    {/* Avatar */}
                    <div className="relative -mt-16 md:-mt-20 shrink-0">
                         <div className="w-28 h-28 md:w-40 md:h-40 rounded-full border-[4px] md:border-[6px] border-white shadow-lg overflow-hidden bg-gray-50 relative group">
                            <Image 
                                src={profile?.writer.img || "/images/cat_avatar.png"} 
                                alt="Profile" 
                                fill 
                    ...
                    <div className="flex gap-3 pb-2 w-full md:w-auto justify-center md:justify-start">
                        <Button 
                            ...
                            className={`rounded-full px-6 h-10 font-medium transition-all flex items-center gap-2 shadow-sm ${
                                isFollowing 
                        ...
                        >
                            {isFollowing ? (
                                <>  
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm">กำลังติดตาม</span>
                                    </div>
                                </>
                            ) : (
                                <>
                         ...
                         <Button 
                            ...
                            className="rounded-full w-10 h-10 flex items-center justify-center border-gray-200 text-gray-500 hover:!text-red-500 hover:!border-red-500 shadow-sm bg-white transition-colors"
                         >
