...
import { fetchCategoryBooks, fetchAllCategories } from "@/services/apiServices";
...
export default function Category() {
  ...
  // Fetch all categories for header info
  const { data: allCategories } = useQuery<CategoryDetail[]>({
    queryKey: ["allCategories"],
    queryFn: fetchAllCategories,
  });

  const categoryDetail = allCategories?.find((c) => String(c.id) === String(categoryId));
