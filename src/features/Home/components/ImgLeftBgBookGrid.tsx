...
import CardBookImageOnly from "@/components/novelCard/CardBookImageOnly";
          ...
          <div className="w-[180px] sm:w-[200px] md:w-[230px] lg:w-[260px] xl:w-[280px] flex-shrink-0 relative">
            ...
            <div className="absolute top-0 left-0 w-full bottom-4 flex items-center justify-center p-1">
              <div className="relative w-full h-full rounded-[16px] sm:rounded-[24px] overflow-hidden">
                <Image src={group.img_left} alt={group.name || 'promotion banner'} fill className="object-contain" unoptimized />
              </div>
            </div>
          </div>
        )}
