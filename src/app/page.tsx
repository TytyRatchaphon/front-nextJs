                                ...
                                <div className="hidden lg:grid grid-cols-2 justify-between items-center mt-4 mb-2">
                                  ...
                                  <div className="flex flex-row justify-end items-end gap-3">
                                    ...
                                    <a className="text-black flex flex-row justify-between items-center font-bold text-nowrap" href="">ดูทั้งหมด
                                      <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" className="ml-3" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708"></path></svg>
                                    </a>
                                  </div>
                                </div>
                            </div>
