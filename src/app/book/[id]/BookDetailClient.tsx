...
import { useGetBookTransById } from '@/hooks/useContents';
...
export default function BookDetailClient({ id }: BookDetailClientProps) {
    const { data: novel } = useGetBookTransById(id as string);
  return (
                                    ...
                                    <div className='grid p-0 md:p-6 '>
                                        <div className='grid md:grid-cols-4 grid-cols-1 mt-6 lg:mt-0'>
                                            ...
                                            <div className='md:col-span-3 p-3 md:px-6 text-wrap text-center md:text-start flex flex-col justify-between'>
                                                <div>
                                                    <Link href="/book" className="hover-link">
                                                        <p className='text-2xl font-bold mb-2 novel-name'>
                                                            {novel?.name}
                                                        </p>
                                                    </Link>
                                                    <p className='text-md mb-2'>
                                                        โดย
                                                        <Link className='text-black font-bold ml-1 hover-link' href="/book">{novel?.user_id}</Link>
                                                    </p>
                                                    <Link className='text-md text-primary mr-2 focus:outline-none' href=""></Link>
                                                    <Link className='text-md text-primary mr-2 focus:outline-none' href=""></Link>
                                                    <div
                                                    ...
                                                    >
                                                        {parse(novel?.title || 'ไม่มีคำอธิบาย')}
                                                    </div>
                                                </div>
                                                <div>
                                                    <div>
                                                        <div className='rounded-lg flex flex-row gap-5 md:gap-20 p-2 py-4 text-md items-center justify-center md:justify-start'>
                                                            ...
                                                            <div className='flex flex-col text-center'>
                                                                <span>จำนวนตอน</span>
                                                                <span className='font-bold text-xl'>{novel?.cat1}</span>
                                                            </div>
                                                            <div className='flex flex-col text-center'>
                                                                <span>ความคิดเห็น</span>
                                                                <span className='font-bold text-xl'>{novel?.cat2}</span>
                                                            </div>
                                                        </div> 
                                                    </div>
                                        ...
                                        <div className='flex flex-1 lg:p-3 flex-col justify-start text-left mb-10 overflow-x-hidden scrollbar-hide'>
                                            <div className=''>
                                                <span className='font-bold text-xl my-10 px-11'>
                                                    แนะนำเรื่อง
                                                </span>
                                            </div>
                                            <div className='mt-15'>
